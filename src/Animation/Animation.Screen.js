  ...
  setupPanResponder() {
    this.rootPanResponder = PanResponder.create({
      ...
      onMoveShouldSetPanResponder: (evt, gestureState) =>{
        return !this.isTouchBtn && this.isLongTouch;
    ...
    if (!this.isLiked) {
      ...
      Animated.parallel([
        Animated.timing(this.tiltIconAnim, {
          toValue: 1,
          duration: this.durationAnimationQuickTouch * this.timeToDelay,
        }),
  ...
  doAnimationLongTouch = () => {
    ...
    Animated.parallel([
      ...
      Animated.timing(this.tiltIconAnim2, {
        toValue: 1,
        duration: this.durationAnimationLongTouch * this.timeToDelay,
      }),
      ...
      Animated.timing(this.fadeBoxAnim, {
        toValue: 1,
        duration: this.durationAnimationBox * this.timeToDelay,
        delay: 100,
      }),
      ...
      () =>
        Animated.parallel([
          Animated.timing(this.zoomIconChosen, {
            toValue: 1.8,
            duration: this.durationAnimationIconWhenDrag * this.timeToDelay,
          }),
  ...
  controlIconWhenRelease = () => {
    ...
    Animated.parallel([
      Animated.timing(this.zoomIconWhenRelease, {
        toValue: 0,
        duration: this.durationAnimationIconWhenRelease * this.timeToDelay,
      }),
      ...
      <Animated.View
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.like_static_fill} />
          </Animated.View>
        </View>
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.love_static} />
          </Animated.View>
        </View>
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.haha_static} />
          </Animated.View>
        </View>
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.wow_static} />
          </Animated.View>
        </View>
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.sad_static} />
          </Animated.View>
        </View>
        ...
        <View style={styles.viewWrapIcon}>
          ...
          <Animated.View
            ...
            <Image style={styles.imgIcon} source={images.angry_static} />
          </Animated.View>
        </View>
      </Animated.View>
    );
